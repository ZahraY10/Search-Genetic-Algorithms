...
//class for Breadth-First-Search(Graph)
...
public class BFS_G {
	...
	Vector<Node> f;
	Vector<String> e;
	int fn = 1; //counting number of created nodes
	int en = 0; //counting number of expanded nodes
	int total = 1; //used memory
	...
	public void search(){
		//check if initial state is our goal state
